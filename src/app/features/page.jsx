    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900 via-white to-purple-50 text-gray-900 dark:text-white transition-colors duration-200">
      <main className="container mx-auto px-4 py-8 relative z-10">
        ...
        <section className="text-center mb-16">
          ...
          <TextAnimate animation="slideLeft" by="character" className="text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto mb-8">
      ...
      <div className="mb-6">
        ...
        <div className="relative mb-6">
          <div className="flex items-center mb-2">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Content Type</span>
          </div>
          <button 
              ...
              >
                {templates.map(template => (
                  <button
                    ...
                    className={`flex items-center w-full px-4 py-3 text-left hover:bg-indigo-50 dark:hover:bg-gray-700 transition-all duration-200 group ${selectedTemplate === template.id ? 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300' : 'text-gray-700 dark:text-gray-300'}`}
                  >
      ...
      <form onSubmit={handleSubmit}>
        <div className="relative">
          <div className="flex items-center mb-2">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Your Topic</span>
          </div>
          <textarea
            value={input}
            onChange={(e) => {
          ...
          <div className="absolute bottom-4 right-4 flex items-center">
            <motion.button
              ...
              className={`p-3 rounded-full shadow-lg transition-all duration-300 ${isGenerating || !input.trim() ? 'bg-gray-300 dark:bg-gray-600 cursor-not-allowed' : 'bg-gradient-to-r from-indigo-600 to-purple-600 cursor-pointer hover:shadow-indigo-500/30 dark:hover:shadow-purple-500/20'}`}
            >
              {isGenerating ? (
                <motion.div
                  animate={{ rotate: 360 }}
        ...
        {isGenerating ? (
          <div className="flex items-center justify-center h-full">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 font-medium">Crafting your content...</p>
          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <h4 className="font-semibold text-gray-600 dark:text-gray-400 mb-2">Awaiting Your Inspiration</h4>
      ...
      {output && (
        <div className="flex justify-between items-center mt-4">
          <div className="text-xs text-gray-500 dark:text-gray-400">
            {output.split(/\s+/).filter(word => word.length > 0).length} words generated
          </div>
