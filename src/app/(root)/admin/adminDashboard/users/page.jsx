...
export default function UsersPage() {
  ...
  const getRoleBadge = (role) => {
    ...
    return (
      <Badge className={`flex items-center gap-1 capitalize border ${colors[role]}`}>
        {icons[role]}
        {role}
      </Badge>
    );
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-indigo-50/30 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900/20 p-6">
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
            <div className="space-y-4">
              ...
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="flex items-center gap-4 py-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center max-w-md">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">There was a problem loading the users data.</p>
              <Button onClick={fetchUsers} className="flex items-center gap-2 mx-auto bg-gradient-to-r from-indigo-600 to-purple-600">
                ...
                <Table>
                  <TableHeader className="bg-gray-50 dark:bg-gray-800/50">
                    <TableRow className="border-gray-200 dark:border-gray-700">
                      <TableHead className="w-[300px] font-semibold text-gray-900 dark:text-white">User Info</TableHead>
                      <TableHead className="font-semibold text-gray-900 dark:text-white">Role</TableHead>
                      <TableHead className="font-semibold text-gray-900 dark:text-white">Status</TableHead>
                      <TableHead className="hidden lg:table-cell font-semibold text-gray-900 dark:text-white">Contact</TableHead>
                      <TableHead className="hidden md:table-cell font-semibold text-gray-900 dark:text-white">Joined</TableHead>
                      <TableHead className="w-[80px] font-semibold text-gray-900 dark:text-white">Actions</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {filteredUsers.length === 0 ? (
                      ...
                      filteredUsers.map((user) => (
                        <TableRow key={user._id} className="group hover:bg-gray-50 dark:hover:bg-gray-700/50 border-gray-200 dark:border-gray-700">
                          <TableCell>
                          ...
                          <TableCell className="hidden lg:table-cell">
                            <div className="flex flex-col gap-1 text-sm">
                              {user.phone ? (
                                ...
                                <span className="text-gray-500 dark:text-gray-500 text-xs">No phone</span>
                              )}
                            </div>
                          </TableCell>
            ...
            {selectedUser && (
              <>
                <DialogHeader>
                  ...
                  <DialogDescription className="text-gray-600 dark:text-gray-400">
                    You can only change the role for {selectedUser.name}. Other information is read-only.
                  </DialogDescription>
                </DialogHeader>
