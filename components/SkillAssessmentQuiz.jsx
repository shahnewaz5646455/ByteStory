...
import { CheckCircle, Clock, Award, BarChart3, ArrowRight, ArrowLeft, Star, Target, BookOpen } from 'lucide-react';
...
const SkillAssessmentQuiz = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      type: "multiple",
      options: [
        { id: 'a', text: "Academic papers/research", score: 3, level: "advanced" },
        { id: 'b', text: "Business reports/professional", score: 3, level: "intermediate" },
        { id: 'c', text: "Blog posts/articles", score: 2, level: "intermediate" },
    ...
    },
    {
      ...
      type: "single",
      options: [
        { id: 'a', text: "Very confident - I rarely make mistakes", score: 4, level: "advanced" },
        { id: 'b', text: "Confident - occasional errors", score: 3, level: "intermediate" },
        { id: 'c', text: "Somewhat confident - need occasional help", score: 2, level: "beginner" },
        { id: 'd', text: "Not confident - frequently unsure", score: 1, level: "beginner" }
      ]
    },
    {
      id: 4,
      ...
      type: "single",
      options: [
        { id: 'a', text: "Expert with multiple citation styles", score: 4, level: "advanced" },
        { id: 'b', text: "Comfortable with common styles (APA/MLA)", score: 3, level: "intermediate" },
        { id: 'c', text: "Basic understanding, need guidance", score: 2, level: "beginner" },
        { id: 'd', text: "Little to no experience", score: 1, level: "beginner" }
      ]
    },
    {
      id: 5,
      ...
      type: "single",
      options: [
        { id: 'a', text: "Have established strategies that work", score: 4, level: "advanced" },
        { id: 'b', text: "Can usually work through it", score: 3, level: "intermediate" },
        { id: 'c', text: "Struggle and need help", score: 2, level: "beginner" },
    ...
    },
    {
      ...
      type: "multiple",
      options: [
        { id: 'a', text: "Advanced: LaTeX, Scrivener, academic tools", score: 4, level: "advanced" },
        { id: 'b', text: "Professional: Word, Google Docs, Grammarly", score: 3, level: "intermediate" },
        { id: 'c', text: "Basic: Simple text editors", score: 2, level: "beginner" },
        { id: 'd', text: "AI writing assistants", score: 2, level: "intermediate" }
      ]
    }
  ];
  ...
  const resultLevels = {
    beginner: {
      ...
      description: "Perfect starting point for building strong writing fundamentals",
    ...
    intermediate: {
      ...
      maxScore: 20,
      title: "Skill Refiner",
      description: "Enhance your existing skills and develop professional writing abilities",
  ...
  const getCurrentLevel = () => {
    const totalScore = Object.keys(answers).reduce((score, questionId) => {
      ...
      if (question.type === 'multiple' && Array.isArray(answer)) {
        return score + answer.reduce((sum, ansId) => {
    ...
    return Object.entries(resultLevels).find(([_, level]) => 
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900 dark:text-white">
            Find Your <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">Writing Level</span>
          </h2>
          <p className="text-gray-600 dark:text-gray-300 text-lg md:text-xl max-w-2xl mx-auto">
            Take our 2-minute assessment to discover personalized learning recommendations
          </p>
        </motion.div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-white">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <BarChart3 size={24} />
                <h3 className="text-xl font-semibold">Writing Skill Assessment</h3>
              </div>
              {quizStarted && !showResults && (
              ...
              {!quizStarted ? (
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-md mx-auto">
                    This quick assessment will help us recommend the perfect tutorials for your skill level and goals.
                  </p>
                ...
                >
                  <div className={`w-20 h-20 mx-auto mb-6 bg-gradient-to-r ${levelInfo.color} rounded-full flex items-center justify-center`}>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-6 mb-6">
                    <h5 className="font-semibold mb-3 text-gray-900 dark:text-white">Recommended Learning Path</h5>
                  ...
                  <div className="space-y-3 mb-8">
                    {quizQuestions[currentQuestion].options.map((option) => {
                      const isSelected = quizQuestions[currentQuestion].type === 'multiple' 
                        ? answers[quizQuestions[currentQuestion].id]?.includes(option.id)
                      ...
                      return (
                        ...
                        >
                          <input
                            type={quizQuestions[currentQuestion].type === 'multiple' ? 'checkbox' : 'radio'}
                            ...
                            className="sr-only"
                          />
                          <div className={`w-5 h-5 border-2 rounded flex items-center justify-center mr-3 flex-shrink-0 ${
                            isSelected
        ...
        >
          <p className="text-gray-500 dark:text-gray-400 text-sm">
            Your assessment results help us recommend the most effective learning path for your writing journey
          </p>
        </motion.div>
      </div>
    </section>
